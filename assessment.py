...
def word_length_sorted(words):
    ...
    for word in words:
        word_length.setdefault(len(word), [])
    ...
    for key in sorted(word_length):
        ...
        sorted_word_length.append((key,word_length[key]))
...
def translate_to_pirate_talk(phrase):
    ...
    """
    translate_dic = {"sir": "matey", "hotel": "fleabag inn",
                     "student": "swabbie", "man": "matey",
                     "professor": "foul blaggart","restaurant": "galley",
                     "your": "yer","excuse": "arr","students": "swabbies",
                     "are": "be", "restroom": "head", "my": "me",
                     "is": "be"}

    tranlated_sentence = ""
    for word in phrase.split():
        tranlated_sentence += translate_dic.get(word, word) + " "

    return tranlated_sentence.rstrip()
...
def kids_game(names):
    ...
    """
    from collections import defaultdict
    name_start_letter_dic = defaultdict(list)
    for name in names:
        name_start_letter_dic[name[0]].append(name)
    new_names = [names[0]]

    while new_names[-1][-1] in name_start_letter_dic:
        for word in name_start_letter_dic[new_names[-1][-1]]:   
